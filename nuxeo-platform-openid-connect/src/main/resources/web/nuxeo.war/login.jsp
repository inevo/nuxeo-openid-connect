...
Collection<OpenIDConnectProvider> openIDConnectProviders = OpenIDConnectHelper.getProviders();
              ...
              <tr>
              	<td colspan="2">
              	 <% for (OpenIDConnectProvider provider : openIDConnectProviders) { %>
              	   <a href="<%= provider.getAuthenticationUrl(request.getContextPath() + request.getParameter("requestedUrl")) %>">
